...
{
    public class PinBallBonusSprite : AbstractSprite
    {
        public PinBallBonusSprite(float radius)
        {
            ZIndex = -1;
        ...
        static readonly PropertyChangedEventArgs m_IsActiveArgs =
            NotifyPropertyChangedHelper.CreateArgs<PinBallBonusSprite>(o => o.IsActive);
        #endregion
    }
}
