...
{
    public class PinBallPartition : AbstractArenaStationaryBody
    {
        public PinBallPartition(Point p1, Point p2, float width)
        {
            ...
            Sprite = new PinBallPartitionSprite(p1, p2, width);
        }
    }
}
