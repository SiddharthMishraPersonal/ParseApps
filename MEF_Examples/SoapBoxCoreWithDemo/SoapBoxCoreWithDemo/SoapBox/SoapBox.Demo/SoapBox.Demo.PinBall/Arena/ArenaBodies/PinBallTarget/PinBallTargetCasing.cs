...
{
    public class PinBallTargetCasing : AbstractArenaStationaryBody 
    {
        public PinBallTargetCasing(float x, float y, float angle)
        {
            Friction = 0.1f;
            Restitution = 0.01f;
            InitialX = x;
            InitialY = y;
            InitialAngle = angle;
            Sprite = new PinBallTargetCasingSprite();
        }
    }
}
